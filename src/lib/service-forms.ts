...
export const SERVICE_CATEGORIES: ServiceCategory[] = [
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            hint: "With Visa Proof, if your visa is refused we refund your Amazingfly service charge. The visa fee, VFS/e-Visa fee and the ₦20,000 Visa Proof fee are non-refundable. Not available on fixed-price packages.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    sections: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            type: "radio",
            required: true,
            options: ["In Nigeria", "In Diaspora (Abroad)"],
            showIf: {
              id: "document_service",
              equals: ["Police character certificate"],
            },
          },
          {
            id: "pof_bank",
      ...
      },
      {
        ...
        questions: [
          ...
          { id: "passport_number", label: "Passport number", type: "text", half: true },
          {
            id: "identity_repository",
            label: "Identity repository",
            type: "radio",
            required: true,
            options: ["NIN", "BVN"],
            showIf: { id: "police_location", equals: ["In Diaspora (Abroad)"] },
          },
          {
            id: "identity_number",
            label: "NIN or BVN number",
            type: "text",
            required: true,
            half: true,
            showIf: { id: "police_location", equals: ["In Diaspora (Abroad)"] },
          ...
          {
            id: "last_nigerian_address",
            label: "Last residential address in Nigeria",
            type: "textarea",
            required: true,
            showIf: { id: "police_location", equals: ["In Diaspora (Abroad)"] },
          },
          {
            id: "nigerian_lga",
            label: "Local Government Area (LGA) of residence in Nigeria",
            type: "text",
            required: true,
            half: true,
            showIf: { id: "police_location", equals: ["In Diaspora (Abroad)"] },
    ...
    documents: [
      ...
      {
        value: "proof_of_foreign_residence",
        label: "Proof of foreign residence",
        hint: "Visa, residence permit/card, recent utility bill, foreign bank statement, or school admission letter.",
        required: true,
        showIf: { id: "police_location", equals: ["In Diaspora (Abroad)"] },
      },
      {
